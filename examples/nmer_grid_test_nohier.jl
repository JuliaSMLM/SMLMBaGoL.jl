# Grid of Identical N-mers (No Hierarchical)
# =========================================
...
# Output
const OUTPUT_DIR = joinpath(@__DIR__, "output", "nmer_grid_nohier")
...
println("="^60)
println("N-mer Grid — Collapsed Gibbs (No Hierarchical) ($(GRID_SIZE)×$(GRID_SIZE) identical $(N_EMITTERS)-mers)")
println("="^60)
...
TRUE_MU = length(locs) / length(true_positions)
