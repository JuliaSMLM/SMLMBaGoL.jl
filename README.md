...
or, in the case that the distribution of blinks per emitter is known (e.g., from a set of calibration data), as
...
emitter.  The second method will use the blinks per emitter distribution defined in 
