...
into several; to guard against this the package provides `estimate_se_adjust`, which infers
an added uncertainty `τ` from the data. Enable it with `se_adjust=:auto` and BaGoL folds `τ`
